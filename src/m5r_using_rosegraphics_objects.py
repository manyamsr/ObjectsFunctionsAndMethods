...
#                attach_to, detach_from, and clone
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center, radius, and fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            render draws all the objects attached to the RoseWindow
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#           close_on_mouse_click closes the RoseWindow when the user clicks on it. This is necessary to allow
#           RoseWindow to be used with multiple functions. In the definition of main in this file, the function call to
#           example2() cannot be executed until example1() is finished with the RoseWindow.
